...
class GetCurrentlyReadingUseCase @Inject constructor(private val bookRepository: BookRepository) {
    operator fun invoke(): Single<List<Book>> = bookRepository.getCurrentlyReading()
}